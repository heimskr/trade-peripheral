...
public class SoulSauceFluid extends FluidCoFH {
    ...
    protected SoulSauceFluid(String key, String stillTexture, String flowTexture) {
        ...
        bucket = Registration.ITEMS.register(bucket(key), () -> new BucketItem(stillFluid, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).tab(TradePeripheral.TAB)));
