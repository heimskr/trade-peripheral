package gay.heimskr.tradeperipheral.common.addons.computercraft.integrations;

import dan200.computercraft.api.peripheral.IPeripheral;
import dan200.computercraft.api.peripheral.IPeripheralProvider;
import gay.heimskr.tradeperipheral.TradePeripheral;
import gay.heimskr.tradeperipheral.common.util.Platform;
import gay.heimskr.tradeperipheral.lib.integrations.IPeripheralIntegration;
import gay.heimskr.tradeperipheral.lib.peripherals.BlockEntityIntegrationPeripheral;
    ...
    public static void load() {
        for (String mod : SUPPORTED_MODS) {
            ...
            integration.ifPresent(obj -> {
                TradePeripheral.LOGGER.warn("Successfully loaded integration for {}", mod);
                ((Runnable) obj).run();
            });
            if (integration.isEmpty()) TradePeripheral.LOGGER.warn("Failed to load integration for {}", mod);
        }
    }
