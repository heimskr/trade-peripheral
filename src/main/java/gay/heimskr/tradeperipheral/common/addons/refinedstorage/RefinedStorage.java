...
import gay.heimskr.tradeperipheral.common.util.StringUtil;
...
public class RefinedStorage {
    ...
    public static String getFingerpint(ItemStack stack) {
        ...
        try {
            ...
            TradePeripheral.debug("Could not parse fingerprint.");
            ex.printStackTrace();
        }
        return "";
    }
    ...
    public void initiate() {
        api.getNetworkNodeRegistry().add(new ResourceLocation(TradePeripheral.MOD_ID, "rs_bridge"), (tag, world, pos) -> read(tag, new RefinedStorageNode(world, pos)));
    }
